class Enigma:
    ...
    def encipher(self,letter):
        ...
        if (self.r2.notch==self.r2.left[0] and self.r3.notch == self.r3.left[0]):
            self.r1.rotate()
            self.r2.rotate()
            self.r3.rotate()
            ...
            self.r2.rotate()
            self.r3.rotate()
        elif self.r3.notch == self.r3.left[0]:
            self.r2.rotate()
            self.r3.rotate()
        else:
            self.r1.rotate()
    ...
    def set_notch(self,rings):
        self.r1.ring(rings[0])
        self.r2.ring(rings[1])
        self.r3.ring(rings[2])